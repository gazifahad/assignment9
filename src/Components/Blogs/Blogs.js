...
const Blogs = () => {
    return (
        <div>
            <h1 className='text-yellow-800 my-5'>what is semantic tag?</h1>
            ...
            <h1 className='text-yellow-800 my-5 mx-5'>inline block inline-block elements?</h1>
            ...
            <h1 className='text-yellow-800 my-5 mx-5'>Context API?</h1>

            <p className='text-left m-6'> We know in REACT the props can be delivered to childs from parents only.But for working purpose sometimes we need to pass from bottom to top also.The solution is context API.It is a way to make global variables that can be passed anywhere.SO we props can be passed from any level of the code to any other level without any hardship through context API.
